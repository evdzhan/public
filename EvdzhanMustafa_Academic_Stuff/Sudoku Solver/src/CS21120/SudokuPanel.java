 ...
 */
 ...
 public void paintComponent(Graphics g) {
    ...
    draw(g);}
 /**
  * Prompt the user for file to choose. 
  * Makes use of setTheFile() method.
  * If  a file is successfully loaded it is displayed on the screen.
  */
public void load(){
	this.setTheFile();
	if(fileLoaded) {
...
public void draw(Graphics g) {
	 g.setColor(Color.red);
	  g.drawLine(160, 65, 160, 205);  g.drawLine(205, 65, 205, 205);
	  g.drawLine(112, 65, 112, 205);  g.drawLine(250, 65, 250, 205);
	  g.drawLine(112, 112, 250, 112); g.drawLine(112, 158, 250, 158);
	  g.drawLine(112, 205, 250, 205); g.drawLine(112, 65, 250, 65);
...
public void solve() {
	...
	"No file loaded, please press the \"Load\" button to choose one.", "What ... REALLY ?  !",
...
public void setTheFile() {
	...
	if(returnedVal == theChooser.APPROVE_OPTION) {
		File file=theChooser.getSelectedFile();
		  ...
		  loader.Load(file);
		  if(!loader.fileOK()) {
			  JOptionPane.showMessageDialog(new JFrame(), "Bad file, please select correct file.", 
