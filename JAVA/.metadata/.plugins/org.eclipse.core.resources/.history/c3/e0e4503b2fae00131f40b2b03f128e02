 ...
 */
	...
	public SudokuFrame() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		 ...
		 buttons=new JPanel(); buttons.setLayout(new GridLayout(1,2));
	    load=new JButton("Load");  load.addActionListener(this);
	    solve=new JButton("Solve"); solve.addActionListener(this);
	    exit=new JButton("Exit"); exit.addActionListener(this);
	    buttons.add(load); buttons.add(solve); buttons.add(exit);
	    ...
	    setSize(360,290);  this.setLocation(500,220);
	    setVisible(true); 
