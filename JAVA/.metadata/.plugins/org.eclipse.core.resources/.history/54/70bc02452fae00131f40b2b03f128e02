 ...
 * This class loads a file.
 * Provides methods to check whether the file is good. 
 * Also can return a 2 D int array with the values taken from the file
 */
public class Loader {
	private int sudoku[][];
	public Loader() {
...
public int[][] giveSudoku() {
	...
	return unstable;
	 ...
	 /**
	  * The loading method.
	  * Changes every space in the file to 0. Puts all numbers to a 2D int array.
	  * @param file the file to be loaded
	  */
	 public void Load(File file) {
		try { Scanner infile =new Scanner(new InputStreamReader
